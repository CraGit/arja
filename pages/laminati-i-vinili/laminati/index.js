...
export default function LaminatiStranica({ stranica, podstranice }) {
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Laminati iz naše ponude" />
      </Head>
      <Hero
        naslov={naslovHero}
          ...
          {podstranice.length > 0 &&
            podstranice.map((podstranica) => (
              <ImageCard
                ...
                link={`/laminati-i-vinili/laminati/${podstranica.fields.slug}`}
