...
const AllAreas = ({ activities }) => {
  const router = useRouter();
  return (
    <div>
      <Head>
        <title>
          Best Day Trips and Activities in Croatia | Explore.hr - Only Good
          Spots
        </title>
      ...
      <Section
        ...
        podnaslov={
          router.locale === "en" ? "All Areas Activities" : "Tutte le aree"
        }
        uvod={
          router.locale === "en"
            ? "Check our tours and activities with start from all areas in Croatia"
            : "Guarda i nostri tour e attività con partenza da tutte le aree della Croazia"
        }
      >
